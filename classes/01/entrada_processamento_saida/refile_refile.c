...
int main() {
    ...
    freopen("classes/01/entrada_processamento_saida/arquives/arquive.in", "r", stdin);
    freopen("classes/01/entrada_processamento_saida/arquives/arquive2.out", "w", stdout);
